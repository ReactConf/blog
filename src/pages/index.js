  ...
  <Layout>
    <Wrapper>
      <Hero>
        ...
        <p>
          سلام. در بلاگ همایش ری اکت اولین همایش تخصصی جاوا اسکریپت  و ری اکت در ایران، قراره گزارش ها، اخبار و مقالات مربوط به این گردهمایی را با شما به اشتراک بگذاریم. یک گردهمایی با تلفیق دانش و تجربه در کنار هم.
        </p>
